...
public class TestPrenda {
	...
	public void testCreacionPrendaValida() {
		t1=new TipoDePrenda(Categoria.PARTE_SUPERIOR, "camisa");
	...
	public void testMismoColor() {
		t2=new TipoDePrenda(Categoria.PARTE_SUPERIOR, "remera");
	...
	public void testCategoria() {
		t3=new TipoDePrenda(Categoria.PARTE_INFERIOR, "pantalon");
